...
| GET `/providers/{pid}/albums` | 当前用户专辑列表 | 无 | `{ "ok":true, "data":[{ "provider":"soda", "id":"123", "name":"示例专辑", "coverUrl":"", "trackIds":[] }] }` |
| GET `/providers/{pid}/albums/{id}` | 专辑详情 | `/providers/soda/albums/123` | `{ "ok":true, "data":{ "provider":"soda", "id":"123", "name":"示例专辑", "tracks":[] } }` |
