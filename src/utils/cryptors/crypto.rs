...
use md5::{Digest, Md5};
use rsa::{BigUint, Pkcs1v15Encrypt, RsaPublicKey, pkcs8::DecodePublicKey, traits::PublicKeyParts};
...
mod tests {
    ...
    #[test]
    fn kugou_register_payload_round_trips() {
    ...
    #[test]
    fn kugou_register_rsa_uses_a_1024_bit_block() {
        let encrypted =
