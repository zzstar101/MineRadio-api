...
use crate::librespot_metadata::util::{
    impl_deref_wrapped, impl_from_repeated, impl_try_from_repeated,
};

use crate::librespot_core::{FileId, SpotifyUri};
...
impl TryFrom<&TranscodedPictureMessage> for TranscodedPicture {
    type Error = crate::librespot_core::Error;
