use crate::librespot_core::config::OS;
use crate::librespot_core::spclient::CLIENT_TOKEN;
use crate::librespot_core::token::Token;
use crate::librespot_core::{Error, SessionConfig, util};
use crate::librespot_protocol::login5::login_response::Response;
use crate::librespot_protocol::{
...
impl Login5Manager {
    ...
    /// - user-agent => android or ios | has to be adjusted in [HttpClient::new](crate::librespot_core::http_client::HttpClient::new)
    pub async fn login(
        &self,
        id: impl Into<String>,
