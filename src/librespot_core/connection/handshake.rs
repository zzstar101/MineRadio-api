...
use crate::librespot_core::{diffie_hellman::DhLocalKeys, version};

use crate::librespot_core::protocol;
use crate::librespot_core::protocol::keyexchange::{
    ...
    T: AsyncWrite + Unpin,
{
    ...
    let platform = match crate::librespot_core::config::OS {
